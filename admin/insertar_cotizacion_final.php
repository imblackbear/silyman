 ...
 mysqli_set_charset($conexion,"utf8");
  ...
  $consulta_evaluacion="SELECT * FROM `evaluacion` ;";
     ...
     $result_consulta=  mysqli_query($conexion, $consulta_evaluacion);
      ...
      $consulta=("INSERT INTO `evaluacion`(`idEvaluacion`, `Concepto`, `Costo_serv`, `fecha_consulta`, `cliente_idCliente`, `cotizacion_idCotizacion`) VALUES ($evaluacion,'$concepto',$costo,'$fecha',$idcli,$idco)");
