    ...
    <div class="d-flex justify-content-center align-items-center login-container">
        <form class="login-form text-center needs-validation" action="registro_clientes.php" method="post" onsubmit="return validacion()" >
            ...
            <div class="form-group row">
                ...
                <input type="text" name="num_calle" class="form-control rounded-pill form-control-lg col-sm-9" placeholder="Lugar donde se realizará el sevicio" required pattern="[a-zA-ZÀ-žñ 0-9]+" oninvalid="this.setCustomValidity('Complete el campo e ingrese solo letras y números')" oninput="this.setCustomValidity('')">
                <div class="invalid-feedback">Complete el campo</div>
            </div>
            <div class="form-group row">
